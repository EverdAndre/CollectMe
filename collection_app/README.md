...
- Relatórios em PDF por tipo: geral, acervo, vendidos, comprar e emprestados.
...
![Cadastro de item](docs/images/cadastro-item.png)
...
Para suportar Web, Android ou iOS com segurança, o ponto principal é adaptar a camada de banco de dados em `lib/data/datasources/collection_datasource.dart`.
...
- As versões específicas do projeto ficam registradas em `pubspec.yaml` e `pubspec.lock`.
